Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/OmarBasem/SignalC"
  ...
  s.xcconfig = { 'HEADER_SEARCH_PATHS' => '$(PODS_ROOT)/SignalC/src $(PODS_ROOT)/SignalC/src/curve25519 $(PODS_ROOT)/SignalC/src/curve25519/ed25519 $(PODS_ROOT)/SignalC/src/protobuf-c' }
end
